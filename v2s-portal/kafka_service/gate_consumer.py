...
class GateConsumer:
    ...
    # def process_video(self, obj):
        ...
        # try:
        #     output_path = f"/home/disk2/dachuang1-23/kafka_result/{id}/qa_annos/agqa_frame_size.json"
        #     video_id = "/".join(video_path.split('/')[-2:-1]) + '/' + video_path.split('/')[-1].split('.')[0];
        #     # 使用 OpenCV 获取视频的宽度和高度
        ...
        print(video_id)
        print(video_path)
        # / home / disk2 / dachuang1 - 23 / kafka_result / 530 / qa_annos / agqa_frame_size.json
        # 530 / test
        # / home / disk2 / dachuang1 - 23 / kafka_result / 530 / test.mp4
        ...
        # 调用脚本进行预处理！
        try:
            subprocess.run(['python3', '/home/disk2/dachuang1-23/mist/extract/extract_clip_features.py', str(id)])
            print("预处理成功！")
