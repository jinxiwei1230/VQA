...
# Fill the paths
DEFAULT_DATASET_DIR = "/home/disk2/dachuang1-23/data/datasets/"  # where the datasets folders are
DEFAULT_CKPT_DIR = "/home/disk2/dachuang1-23/data/save_models/"   # where the training checkpoints and logs will be saved
DEFAULT_MODEL_DIR = "/home/disk2/dachuang1-23/data/"  # where the pretrained models are
