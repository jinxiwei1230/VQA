...
class Bert(nn.Module):
    ...
    def __init__(self):
        ...
        self.bert_tokenizer = BertTokenizer.from_pretrained("/home/disk2/dachuang1-23/data/models/bert-base-uncased")
        self.bert = BertModel.from_pretrained("/home/disk2/dachuang1-23/data/models/bert-base-uncased")
...
class DistilBert(nn.Module):
    ...
    def __init__(self):
        super(Bert, self).__init__()
        self.bert_tokenizer = DistilBertTokenizer.from_pretrained("/home/disk2/dachuang1-23/data/models/distilbert-base-uncased")
        self.bert = DistilBertModel.from_pretrained("/home/disk2/dachuang1-23/data/models/distilbert-base-uncased")
