...
def get_args(id):
    ...
    parser.add_argument(
        "--dataset_dir",
        type=str,
        default=f'/home/disk2/dachuang1-23/kafka_result/{id}/qa_annos/',
        help="folder where the datasets folders are stored",
    )
    parser.add_argument(
        "--feature_dir",
        type=str,
        default=f'/home/disk2/dachuang1-23/kafka_result/{id}/',
        help="folder where the datasets folders are stored",
    )
    parser.add_argument(
        "--checkpoint_predir",
    ...
    parser.add_argument(
        "--test", type=int, default=1, help="use to evaluate without training"
    )
    parser.add_argument("--id", type=int, default=id)
    parser.add_argument(
    ...
    # Print
    parser.add_argument(
        "--freq_display", type=int, default=10, help="number of train prints per epoch"
    )
    parser.add_argument(
        "--num_thread_reader", type=int, default=8, help="number of workers"
    )
    ...
    parser.add_argument(
        "--save_dir", type=str, default=f'/home/disk2/dachuang1-23/kafka_result/{id}/save_models/', help="path to save dir"
    )
    parser.add_argument(
        "--mc", type=int, default=0, help="number of multiple choices"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--vocab_path", type=str, default='/home/disk2/dachuang1-23/data/datasets/agqa/vocab.json', help="path to save dir"
    )
    ...
    args.load_path = args.dataset_dir

    # args.features_path = os.path.join(args.feature_dir, args.dataset)
    args.features_path = args.feature_dir
