...
class BaseDatasetBuilder:
    ...
    def __init__(self, cfg=None):
        ...
        self.data_type = self.config.data_type  # 数据集数据类型：images/videos/features
        # 构建基础的视觉和文本处理器
            ...
            for url_or_filename, storage_path in zip(urls, storage_paths):
                ...
                if os.path.isfile(url_or_filename):
                    ...
                    if os.path.isdir(storage_path):
                        ...
                        raise ValueError(
                            f"Expecting storage_path to be a file path, got directory {storage_path}".format(
                                storage_path
                            )
                        )
                    else:
    ...
    def build(self):
        ...
        """
        self.build_processors() # 按配置构建视觉和文本处理器实例
        ...
        for split in ann_info.keys():
            ...
            # create datasets
            # 获取数据集类 lavis/datasets/datasets/ 基类：BaseDataset
